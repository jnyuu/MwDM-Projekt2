async function preprocessImage(imgBlob, width, height, canvas, img) {
  const ctx = canvas.getContext("2d");

  img.current.src = imgBlob.src;
  ...
  //   blurARGB(image.data, canvas, );
  dilate(image.data, canvas);
  //   invertColors(image.data);
  // console.log(ctx);
  //   thresholdFilter(image.data, 0.95);
  return image;
}
...
// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
function blurARGB1(pixels, canvas, radius) {
